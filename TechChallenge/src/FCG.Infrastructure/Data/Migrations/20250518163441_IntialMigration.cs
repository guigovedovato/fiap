        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LibraryId1 = table.Column<Guid>(type: "TEXT", nullable: false),
                    LibraryItemModelId = table.Column<int>(type: "INTEGER", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Games_LibraryItemModel_LibraryItemModelId",
                        column: x => x.LibraryItemModelId,
                        principalTable: "LibraryItemModel",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Games_Library_LibraryId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Games_LibraryId1",
                table: "Games",
                column: "LibraryId1");

            migrationBuilder.CreateIndex(
                name: "IX_Games_LibraryItemModelId",
                table: "Games",
